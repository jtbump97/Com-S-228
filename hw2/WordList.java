...
public class WordList implements Cloneable {
	 ...
	 *             if {@code idx} is negative or greater than or equal to the
	 *             length of the list
	 */
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if either of {@code idxA} or {@code idxB} is negative or
	 *             greater than or equal to the length of the list
	 */
	public void swap(int idxA, int idxB) throws IndexOutOfBoundsException {
		String[] tempA = words.clone();
		words[idxA] = tempA[idxB];
		words[idxB] = tempA[idxA];
