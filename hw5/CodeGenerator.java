...
public class CodeGenerator {
	...
	/**
	 * Constructs a CodeGenerator that uses the given values. Does not perform
	 * deep copies.
	 *
	 * Preconditions: - elements of T1 are all the same length - T2 is the same
	 * size as T1 - G.length == words.size()
	 *
	 * @param table1
	 *            the table T1
	 * @param table2
	 ...
	 */
	public void generate(OutputStream output, String className)
		    throws NullPointerException,
	           IllegalArgumentException
	  {
	 ...
	 */
	private void hashFunction(PrintStream ps, String access, String t1Name, String t2Name,
            String graphName, int modulus, int size)
{
 ...
 ps.println("}");
	...
	/**
	 * Prints the given block comment to the given stream. Each string within
	 * the given array is a line in the comment.
	 *
	 * @param ps
	 *            the stream to print to
	 * @param commentText
